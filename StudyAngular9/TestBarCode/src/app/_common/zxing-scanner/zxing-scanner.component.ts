import { Component, OnInit, ChangeDetectionStrategy, AfterViewInit, OnDestroy, ViewChild, ElementRef, Input, EventEmitter, Output } from '@angular/core';
import { DecodeHintType, Exception, Result, ArgumentException, BarcodeFormat } from '@zxing/library';
...
export class ZXingScannerComponent implements OnInit, AfterViewInit, OnDestroy {
  /**
     * Supported Hints map.
     */
